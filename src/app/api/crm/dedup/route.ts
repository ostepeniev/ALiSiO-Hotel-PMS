...
/* ================================================================
   Normalize phone for dedup matching
   ================================================================ */
...
/* ================================================================
   POST /api/crm/dedup — Check for duplicate leads/guests
   
   Body: { email?, phone?, whatsapp?, lastName?, externalBookingId? }
   
   Returns:
   - { found: false } if no duplicates
   - { found: true, matches: [...] } with all matching records
   ================================================================ */
export async function POST(request: NextRequest) {
  try {
    ...
    // 5. Last name (fuzzy — cross-check leads and guests)
    if (lastName) {
      const leads = db.prepare(
